...
import static com.example.trivia.R.layout.activity_quiz;

public class QuizActivity extends AppCompatActivity {

    Questions qAndA = new Questions();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        qAndA = (Questions) i.getSerializableExtra("question");
        if (qAndA != null) {
            q_nos = "Question: " + 1 + "/" + qAndA.questions.size();
        }
        questions = findViewById(R.id.question);
        questions.setText(R.string.quiz);
    ...
    public void clickNext(View view) {
        ...
        if (ques < qAndA.questions.size() - 2) {
            optionsGroup.clearCheck();
            goNext();
        } else if (ques == qAndA.questions.size() - 2) {
    ...
    public void goNext() {
        ...
        if (ques >= qAndA.questions.size()) {
            ques = qAndA.questions.size() - 1;
        }

        q_nos = "Question: " + (ques + 1) + "/" + qAndA.questions.size();
        q_no.setText(q_nos);
        questions.setText(qAndA.questions.get(ques));
    ...
    public void clickPrev(View view) {
        ...
        if (ques < qAndA.questions.size() - 1) {
            goPrev();
        } else if (ques == qAndA.questions.size() - 1) {
            Button button = findViewById(R.id.next);
            button.setVisibility(View.VISIBLE);
            button = findViewById(R.id.submit);
            button.setVisibility(View.INVISIBLE);
    ...
    public void submit(View view){
        ...
        if (submit)
            checkScore();
        submit = false;
        percentage = (float)(score*100)/qAndA.questions.size();
        ...
        progressBar.setMax(qAndA.questions.size());
        progressBar.setSecondaryProgress(qAndA.questions.size());
        ...
        alert.setMessage("You scored "+score + " out of " + qAndA.questions.size()+" questions.");
    ...
    public void clickSubmit(final View view) {
        ...
        alertConfirm.setMessage("Do you want to submit your quiz?");
    ...
    public void clickSolutions() {
        ...
        solutions.putStringArrayListExtra("Question", (ArrayList<String>) qAndA.questions);
